...
- Sign up for a [GitHub](https://github.com/) account (If you don't have one).
...
## Database Profile
The `executeDbProfile` function in **DbDiagnostics** package relies on the **Achilles** and **DataQualityDashboard** packages to run a subset 
...
in the output folder. If neither is present, the function will ask the user a series of questions in the form of pop-ups and save 
...
from the **OhdsiSharing** R package. More details about how to share the database profile results can be found in 
